...
#     end_date: Union[datetime, str] = datetime.today() + relative_delta(months=3)
...
#             self.start_date = datetime.strp_time(self.start_date, "%m/%d/%Y")
#         elif not isinstance(self.start_date, datetime):
#             raise ValueError('That\'s is not a valid date format')
#
#         if isinstance(self.end_date, str):
#             self.end_date = datetime.strp_time(self.end_date, "%m/%d/%Y")
